...
namespace App.Utils
{
    ...
    public static class Число
    {
        ...
        class ЦифраИзменяющаясяПоРодам : Цифра, IИзменяетсяПоРодам
        {
            ...
            public string Мужской { get { return мужской; } }
            public string Женский { get { return женский; } }
            public string Средний { get { return средний; } }
            public string Множественное { get { return множественное; } }
        ...
        class Класс : IЕдиницаИзмерения
        {
            ...
            public string ИменЕдин { get { return начальнаяФорма; } }
            public string РодЕдин { get { return начальнаяФорма; } }
            public string РодМнож { get { return начальнаяФорма; } }
        ...
        /// Между вызовами <see cref="Append"/> вставляет пробелы.
        /// </summary>
