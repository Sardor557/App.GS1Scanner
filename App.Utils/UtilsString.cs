...
namespace App.Utils
{
    ...
    {
        private static readonly char[] SanitizeChr = new[] { '\'', '\"' };
        ...
        {
            return Convert.ToInt32(source.Replace(" ", ""));
        }
        ...
        public static string ReplaceAll(this string s, string find, string to)
        {
        ...
        public static string RemoveCharsAll(this string s, char find)
        {
            while (s.IndexOf(find) > -1)
            {
                s = s.RemoveChars(find);
            }
