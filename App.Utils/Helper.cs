...
namespace App.Utils
{
    ...
    public static class Helper
    {
        ...
        public static void AddOutParameter(this IDbCommand command,
                                   ...
                                   DbType dbType)
        {
            command.AddParameter(name, dbType, ParameterDirection.Output, name, DataRowVersion.Default, null);
        }
        ...
        public static void AddInParameter(this IDbCommand command,
                                   ...
                                   object value)
        {
            command.AddParameter(name, dbType, ParameterDirection.Input, string.Empty, DataRowVersion.Default, value);
        }
        ...
        public static void AddParameter(this IDbCommand command,
                                 ...
                                 object value)
        {
            command.AddParameter(name, dbType, 0, direction, false, 0, 0, sourceColumn, sourceVersion, value);
        }
        ...
        public static string ToSQLDateTime(this DateTime? pDate)
        {
            ...
            else return ((DateTime)pDate).ToSQLDateTime();
        }
        ...
        {
            if (pDate == null) return string.Empty;
            else return ((DateTime)pDate).ToSQLDate();
        }
