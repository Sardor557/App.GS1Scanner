...
namespace App.Utils
{
    public static class DateTimeExtensions
    {
        ...
        public static string ToStrDateTimeNull(this DateTime? inParam, string format = "dd.MM.yyyy HH:mm:ss")
        {
            if (inParam == null)
                return "";
            else
        ...
        public static string ToPostgesSqlDate(this DateTime source, int type = 0)
        {
            var res = "";
            switch (type)
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    res = $"'{source:yyyy-MM-dd} 00:00:00'";
                    break;
                case 2:
                    res = $"'{source:yyyy-MM-dd 23:59:59'}";
                    break;
