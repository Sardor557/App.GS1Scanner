...
namespace App.Utils
{
    public static class TryConvert
    {
        ...
        public static bool ToInt64(object v, out long value)
        {
            try
            {
        ...
        public static bool ToDateTime(string str, out DateTime value, string format)
        {
            try
            {
                value = DateTime.ParseExact(str, format, CultureInfo.CurrentCulture);
                return true;
            }
            catch (Exception)
            {
