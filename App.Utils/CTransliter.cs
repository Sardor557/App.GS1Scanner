...
namespace App.Utils
{
    public class CTransliter
    {
        ...
        /// keybord kes
        /// </summary>
        public const string LETTER_EN_K = "QWERTYUIOP[]ASDFGHJKL;'ZXCVBNM,.`-’ ";
        ...
        public static bool RuToEn_Keybord(ref string s)
        {
            string r = "";
            for (int i = 0; i < s.Length; i++)
            {
                char c = s[i];
                int p = LETTER_EN_K.IndexOf(c);
        ...
        public static ushort PkCorrect(string pk, string date_birth, string s)
        {
